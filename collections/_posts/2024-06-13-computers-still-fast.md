...
<script>
    ...
    const options = [1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000];
    let score = 0;
    let answered = 0;
    let unanswered = 0;
    ...
    function createQuiz(language) {
        ...
        questions.forEach((question, index) => {
            ...
            options.forEach(option => {
                ...
                button.textContent = option.toLocaleString("en-GB");
    ...
    function checkAnswer(language, button, correctAnswer, exactAnswer, questionDiv) {
        ...
        const givenAnswer = parseInt(button.dataset.value);
